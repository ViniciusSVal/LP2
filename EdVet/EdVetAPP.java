...
public class EdVetAPP {
	public static void main (String[] args) {
		...
		//frame.rects[0] = ...
		frame.rects.add(new Rect(30, 30, 50, 100, outColor, bgColor));

		//adicionando o 2° retangulo na lista de retangulos
		outColor = new Color(0, 128, 64);
		bgColor = new Color(0, 255, 128);
		//frame.rects[1] = ...
		frame.rects.add(new Rect(100, 50, 150, 75, outColor, bgColor));
...
class Frame extends JFrame {
	...
	ArrayList<Rect> rects = new ArrayList<Rect>(10);
	...
	Frame() {
		...
		this.addMouseListener ( new MouseAdapter() {
			public void mouseClicked (MouseEvent e) {
				...
				//rects[2] ...
				rects.set(2, new Rect(e.getX(), e.getY(), 20, 20, new Color(0,0,0), col));
